...
Selected migration candidate: `78b64636e99fea4ea2d868096576021dd3b8e519`
(`asupersync 0.5.0`, the published v0.5.0 release). **Prepared; native
validation pending.** The last admitted pin remains
`107adf1df8d274b37c6ed9a12471fe3da44429f2` (advanced via `94217a3`,
bead `bd-x7y2r`). The candidate must not inherit that pin's green evidence.
...
| `rabs-cas` FrankenSQLite adapter | The old 0.1.19 backend independently brought registry Asupersync 0.3.10. Select reviewed `fsqlite =0.4.0` with the existing `native` feature to move that graph to 0.5.0. The existing parameter/value conversions remain applicable. Run H009 reference/candidate differential tests, migration rollback and reopen tests before admitting this storage upgrade. |
...
| `107adf1df8d274b37c6ed9a12471fe3da44429f2` | `94217a3` | Last admitted pin; evidence below. |
| `78b64636e99fea4ea2d868096576021dd3b8e519` | migration candidate | 0.5.0; native admission pending. |

### Evidence for the last admitted pin

    ...
    fn sample_status() -> DaemonFullStatusResponse {
        DaemonFullStatusResponse {
            ...
            active_builds: vec![ActiveBuildFromApi {
                ...
                last_heartbeat_at: Some("2026-01-19T00:00:12Z".to_string()),
                heartbeat_age_secs: Some(1),
                last_progress_at: Some("2026-01-19T00:00:12Z".to_string()),
                progress_age_secs: Some(1),
                heartbeat_phase: Some("execute".to_string()),
                heartbeat_detail: Some("Compiling".to_string()),
                heartbeat_counter: Some(8),
                heartbeat_percent: Some(70.0),
                slots: Some(4),
                detector_hook_alive: Some(false),
                detector_heartbeat_stale: Some(true),
                detector_progress_stale: Some(true),
                detector_confidence: Some(0.92),
                detector_build_age_secs: Some(130),
                detector_slots_owned: Some(4),
                detector_last_evaluated_at: Some("2026-01-19T00:00:12Z".to_string()),
            }],
            queued_builds: vec![],
            recent_builds: vec![],

    ...
    >
      ...
      <div className="kv-group">
        ...
        <dl style={{ margin: 0 }}>
          ...
          <Row
            k="Disk IO util"
            v={p.disk_io_util_pct != null ? `${p.disk_io_util_pct.toFixed(0)}%` : "—"}
          />
          <Row
            k="Memory pressure"
            v={p.memory_pressure != null ? `${p.memory_pressure.toFixed(1)}%` : "—"}
          />
          <Row
            k="Telemetry"
            v={
      ...
      <div className="kv-group">
        ...
        <dl style={{ margin: 0 }}>
          ...
          <Row
            k="Projects root"
            v={c.projects_root_ok == null ? "—" : c.projects_root_ok ? "ok" : "UNHEALTHY"}
          />
        </dl>
      </div>
